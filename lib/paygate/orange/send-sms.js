...
const orangeConfig = configModule.orangeConfig;
const assertOrangeConfigured = configModule.assertOrangeConfigured;

async function sendOrangeSms({ to, message }) {
  if (!orangeConfig || typeof orangeConfig !== "object") {
    throw new Error("Orange configuration module invalid");
  }

  if (typeof assertOrangeConfigured !== "function") {
    throw new Error("Orange configuration assertion unavailable");
  }
