...
// Debug logging
console.log("Orange Config Debug:", {
  smsEnabled: orangeConfig.smsEnabled,
  simulation: orangeConfig.simulation,
  countries: orangeConfig.countries,
  clientId: !!orangeConfig.clientId,
  clientSecret: !!orangeConfig.clientSecret,
});
