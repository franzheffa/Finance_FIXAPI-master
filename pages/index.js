...
export default function EliteDashboard() {
  ...
  return (
    React.createElement('div', { style: { backgroundColor:'#FFFFFF', minHeight:'100vh', color:'#000', fontFamily:'-apple-system,BlinkMacSystemFont,sans-serif', overflowX:'hidden' } },
      ...
      momoStep===6 && React.createElement(Sheet, { onClose:rMomo }, React.createElement(Succ, { ref_:momoRef, amount:parseInt(momoAmount).toLocaleString('fr-FR')+' FCFA', label:momoOp?.name, onClose:rMomo })),
